...
if __name__ == '__main__':
    ...
    ## Ha NGUYEN - modified 24/04/2018
    # Change test batch size to 8
    test_loader = AudioDataLoader(test_dataset, batch_size=4,
    ...
    if args.cuda and not args.distributed:
        ## Ha NGUYEN - modified 24/04/2018
        # Add device_ids=[0,1] to specify which GPUs the training runs on
        model = torch.nn.DataParallel(model, device_ids=[0, 5, 6, 7]).cuda()
